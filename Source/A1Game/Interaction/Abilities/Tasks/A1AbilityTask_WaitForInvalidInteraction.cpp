#include "Interaction/Abilities/Tasks/A1AbilityTask_WaitForInvalidInteraction.h"
...
UA1AbilityTask_WaitForInvalidInteraction* UA1AbilityTask_WaitForInvalidInteraction::WaitForInvalidInteraction(
	UGameplayAbility* OwningAbility, float AcceptanceAngle, float AcceptanceDistance)
{
	UA1AbilityTask_WaitForInvalidInteraction* Task = NewAbilityTask<UA1AbilityTask_WaitForInvalidInteraction>(OwningAbility);
	Task->AcceptanceAngle = AcceptanceAngle;
	Task->AcceptanceDistance = AcceptanceDistance;
	return Task;
}

void UA1AbilityTask_WaitForInvalidInteraction::Activate()
{
	Super::Activate();
...
void UA1AbilityTask_WaitForInvalidInteraction::OnDestroy(bool bInOwnerFinished)
{
...
void UA1AbilityTask_WaitForInvalidInteraction::PerformCheck()
{
...
float UA1AbilityTask_WaitForInvalidInteraction::CalculateAngle2D() const
{
