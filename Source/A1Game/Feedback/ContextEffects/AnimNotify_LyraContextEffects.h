...
struct A1GAME_API FLyraContextEffectAnimNotifyVFXSettings
{
	GENERATED_BODY()
 ...
 */
USTRUCT(BlueprintType)
struct A1GAME_API FLyraContextEffectAnimNotifyAudioSettings
{
	GENERATED_BODY()
 ...
 */
USTRUCT(BlueprintType)
struct A1GAME_API FLyraContextEffectAnimNotifyTraceSettings
{
	GENERATED_BODY()
 ...
 */
USTRUCT(BlueprintType)
struct A1GAME_API FLyraContextEffectAnimNotifyPreviewSettings
{
	GENERATED_BODY()
...
class A1GAME_API UAnimNotify_LyraContextEffects : public UAnimNotify
{
	GENERATED_BODY()
