...
struct A1GAME_API FLyraContextEffects
{
	GENERATED_BODY()
 ...
 */
UCLASS()
class A1GAME_API ULyraActiveContextEffects : public UObject
{
	GENERATED_BODY()
...
class A1GAME_API ULyraContextEffectsLibrary : public UObject
{
	GENERATED_BODY()
