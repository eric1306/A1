...
class A1GAME_API ULyraContextEffectsSettings : public UDeveloperSettings
{
	GENERATED_BODY()
 ...
 */
UCLASS()
class A1GAME_API ULyraContextEffectsSet : public UObject
{
	GENERATED_BODY()
 ...
 */
UCLASS()
class A1GAME_API ULyraContextEffectsSubsystem : public UWorldSubsystem
{
	GENERATED_BODY()
