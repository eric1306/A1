...
UAsyncAction_ObserveTeam* UAsyncAction_ObserveTeam::InternalObserveTeamChanges(TScriptInterface<IA1TeamAgentInterface> TeamActor)
{
...
void UAsyncAction_ObserveTeam::SetReadyToDestroy()
{
	...
	if (IA1TeamAgentInterface* TeamInterface = TeamInterfacePtr.Get())
	{
