...
public:
	...
	//  - For anything that can ever belong to a team (implements IA1TeamAgentInterface),
...
private:
	...
	static UAsyncAction_ObserveTeam* InternalObserveTeamChanges(TScriptInterface<IA1TeamAgentInterface> TeamActor);

private:
	UFUNCTION()
	void OnWatchedAgentChangedTeam(UObject* TeamAgent, int32 OldTeam, int32 NewTeam);

	TWeakInterfacePtr<IA1TeamAgentInterface> TeamInterfacePtr;
};
