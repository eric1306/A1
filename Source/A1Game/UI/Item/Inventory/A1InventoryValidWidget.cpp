...
#include UE_INLINE_GENERATED_CPP_BY_NAME(A1InventoryValidWidget)

UA1InventoryValidWidget::UA1InventoryValidWidget(const FObjectInitializer& ObjectInitializer)
	: Super(ObjectInitializer)
{
}

void UA1InventoryValidWidget::NativeOnInitialized()
{
...
void UA1InventoryValidWidget::ChangeSlotState(ESlotState SlotState)
{
	switch (SlotState)
	{
