...
void ULyraLocalPlayer::OnPlayerControllerChanged(APlayerController* NewController)
{
	...
	if (IA1TeamAgentInterface* ControllerAsTeamProvider = Cast<IA1TeamAgentInterface>(LastBoundPC.Get()))
	{
...
{
	if (IA1TeamAgentInterface* ControllerAsTeamProvider = Cast<IA1TeamAgentInterface>(PlayerController))
	{
...
FOnA1TeamIndexChangedDelegate* ULyraLocalPlayer::GetOnTeamIndexChangedDelegate()
{
