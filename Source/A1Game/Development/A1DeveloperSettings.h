...
#include "A1DeveloperSettings.generated.h"
...
class UA1DeveloperSettings : public UDeveloperSettingsBackedByCVars
{
	GENERATED_BODY()

public:
	UA1DeveloperSettings();
...
public:
	...
	A1GAME_API void OnPlayInEditorStarted() const;
