 ...
 */
UCLASS()
class A1GAME_API ULyraInputUserSettings : public UEnhancedInputUserSettings
{
	GENERATED_BODY()
public:
 ...
 */
UCLASS()
class A1GAME_API ULyraPlayerMappableKeySettings : public UPlayerMappableKeySettings
{
	GENERATED_BODY()
