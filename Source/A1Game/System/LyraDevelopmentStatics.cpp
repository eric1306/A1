...
bool ULyraDevelopmentStatics::ShouldSkipDirectlyToGameplay()
{
	...
	if (GIsEditor)
	{
		return !GetDefault<UA1DeveloperSettings>()->bTestFullGameFlowInPIE;
	}
#endif
	return false;
}
...
bool ULyraDevelopmentStatics::ShouldLoadCosmeticBackgrounds()
{
	...
	if (GIsEditor)
	{
		return !GetDefault<UA1DeveloperSettings>()->bSkipLoadingCosmeticBackgroundsInPIE;
	}
#endif
	return true;
}
...
bool ULyraDevelopmentStatics::CanPlayerBotsAttack()
{
	...
	if (GIsEditor)
	{
		return GetDefault<UA1DeveloperSettings>()->bAllowMonstersAttackPlayer;
	}
#endif
	return true;
}
