...
#include "AbilitySystem/A1ActivateAbilitiesGameplayEffectComponent.h"
...
#include UE_INLINE_GENERATED_CPP_BY_NAME(A1ActivateAbilitiesGameplayEffectComponent)

#define LOCTEXT_NAMESPACE "ActivateAbilitiesGameplayEffectComponent"

UA1ActivateAbilitiesGameplayEffectComponent::UA1ActivateAbilitiesGameplayEffectComponent()
{
...
bool UA1ActivateAbilitiesGameplayEffectComponent::OnActiveGameplayEffectAdded(FActiveGameplayEffectsContainer& ActiveGEContainer, FActiveGameplayEffect& ActiveGE) const
{
...
void UA1ActivateAbilitiesGameplayEffectComponent::OnActiveGameplayEffectRemoved(const FGameplayEffectRemovalInfo& RemovalInfo, FActiveGameplayEffectsContainer* ActiveGEContainer) const
{
...
void UA1ActivateAbilitiesGameplayEffectComponent::OnGameplayEffectApplied(FActiveGameplayEffectsContainer& ActiveGEContainer, FGameplayEffectSpec& GESpec, FPredictionKey& PredictionKey) const
{
	UAbilitySystemComponent* ASC = ActiveGEContainer.Owner;
	if (ensure(ASC) == false)
		return;
...
#if WITH_EDITOR
EDataValidationResult UA1ActivateAbilitiesGameplayEffectComponent::IsDataValid(FDataValidationContext& Context) const
{
