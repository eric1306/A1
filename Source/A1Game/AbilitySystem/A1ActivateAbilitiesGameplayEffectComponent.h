...
#include "A1ActivateAbilitiesGameplayEffectComponent.generated.h"
...
class A1GAME_API UA1ActivateAbilitiesGameplayEffectComponent : public UGameplayEffectComponent
{
	GENERATED_BODY()

public:
	UA1ActivateAbilitiesGameplayEffectComponent();
