...
void ULyraExperienceManagerComponent::StartExperienceLoad()
{
	...
	UE_LOG(LogA1Experience, Log, TEXT("EXPERIENCE: StartExperienceLoad(CurrentExperience = %s, %s)"),
...
void ULyraExperienceManagerComponent::OnExperienceLoadComplete()
{
	...
	UE_LOG(LogA1Experience, Log, TEXT("EXPERIENCE: OnExperienceLoadComplete(CurrentExperience = %s, %s)"),
		*CurrentExperience->GetPrimaryAssetId().ToString(),
		*GetClientServerContextString(this));
...
void ULyraExperienceManagerComponent::EndPlay(const EEndPlayReason::Type EndPlayReason)
{
	...
	if (LoadState == ELyraExperienceLoadState::Loaded)
	{
		...
		{
			UE_LOG(LogA1Experience, Error, TEXT("Actions that have asynchronous deactivation aren't fully supported yet in Lyra experiences"));
		}
