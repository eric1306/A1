...
class A1GAME_API ULyraReplayListEntry : public UObject
{
	GENERATED_BODY()
...
UCLASS(BlueprintType)
class A1GAME_API ULyraReplayList : public UObject
{
	GENERATED_BODY()
...
UCLASS()
class A1GAME_API ULyraReplaySubsystem : public UGameInstanceSubsystem
{
	GENERATED_BODY()
