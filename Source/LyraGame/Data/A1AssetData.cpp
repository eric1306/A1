...
EDataValidationResult UA1AssetData::IsDataValid(FDataValidationContext& Context) const
{
...
FSoftObjectPath UA1AssetData::GetAssetPathByName(const FName& AssetName) const
{
...
const FAssetSet& UA1AssetData::GetAssetSetByLabel(const FName& Label) const
{
